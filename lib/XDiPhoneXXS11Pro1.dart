    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        ...
                        Pin(size: 146.0, start: 92.8),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              Pin(start: -52.6, end: -28.8),
                              Pin(start: -14.6, end: -180.5),
                              child:
                      ...
                      Pinned.fromPins(
                        Pin(size: 102.0, start: 27.8),
                        Pin(size: 17.0, middle: 0.4011),
                        child: Text(
                          '立て替え金額',
                          style: TextStyle(
                      ...
                      Pinned.fromPins(
                        Pin(size: 108.0, end: 40.0),
                        Pin(size: 30.0, middle: 0.4103),
                        child: Text(
                          '¥49,899',
                          style: TextStyle(
                            fontFamily: 'Gotham',
                      ...
                      Pinned.fromPins(
                        Pin(size: 43.0, start: 27.8),
                        Pin(size: 19.0, middle: 0.4304),
                        child: Text(
                          '5月分',
                          style: TextStyle(
                            fontFamily: 'Gotham',
                      ...
                      Pinned.fromPins(
                        Pin(start: 34.9, end: 29.9),
                        Pin(size: 14.0, middle: 0.6145),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                      ...
                      Pinned.fromPins(
                        Pin(start: 34.9, end: 27.9),
                        Pin(size: 14.0, middle: 0.6571),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              Pin(size: 52.0, start: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 75.0, end: 13.0),
            Pin(size: 15.0, start: 12.0),
            child: Text(
              'ログアウト',
              style: TextStyle(
                fontFamily: 'Gotham',
...
const String _svg_y25cn9 =
    '<svg viewBox="810.0 1036.0 373.0 250.0" ><path transform="translate(810.0, 1036.0)" d="M 10 0 L 363 0 C 368.5228576660156 0 373 4.477152347564697 373 10 L 373 250 L 0 250 L 0 10 C 0 4.477152347564697 4.477152347564697 0 10 0 Z" fill="#a99bf7" stroke="#a99bf7" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_y5x6p6 =
    '<svg viewBox="821.3 1506.2 350.0 1.0" ><path transform="translate(821.25, 1506.16)" d="M 0 0 L 350 0" fill="none" fill-opacity="0.6" stroke="#8898aa" stroke-width="0.5" stroke-opacity="0.6" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
