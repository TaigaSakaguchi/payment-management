...
class RegisterPaymentPage extends StatelessWidget {
  RegisterPaymentPage({Key key}) : super(key: key);
      ...
      body: Stack(
        children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(size: 239.7, middle: 0.5056),
                        Pin(size: 40.0, middle: 0.4741),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 77.7, middle: 0.168),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 34.0, start: 2.8),
                      ...
                      Pinned.fromPins(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                width: 1.0, color: const Color(0xcc7764e4)),
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0x25171717),
                                offset: Offset(0, 2),
                                blurRadius: 4,
                              ),
                            ],
